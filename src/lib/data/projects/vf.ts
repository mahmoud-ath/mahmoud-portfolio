...
const staticProjectsData: Project[] = [
  {
    ...
    title: "CMH - Data Management System",
    description: "An advanced email management system built with Django REST Framework and React. Features include secure authentication, role-based access control, real-time notifications, and comprehensive email workflow management with advanced filtering and search capabilities.",
    category: "web-dev",
  ...
  // watchly-ai
   {
    ...
    slug: "watchly-ai",
    title: "Watchly AI",
    description: "Watchly: Discover, Track, Share. Your all-in-one hub for movies & TV. Search millions of titles, save your watchlist, and share recommendations—all powered by TMDB's live database. you can visit the demo and live the experience.",
    category: "web-dev",
    tags: [
      "react",
      "typescript",
...
/**
 * Export projects data for display and admin operations
 */
export const projectsData: Project[] = staticProjectsData;
